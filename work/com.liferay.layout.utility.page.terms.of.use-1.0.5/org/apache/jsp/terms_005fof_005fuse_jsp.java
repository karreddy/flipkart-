...
LayoutUtilityPageEntry layoutUtilityPageEntry = LayoutUtilityPageEntryLocalServiceUtil.fetchDefaultLayoutUtilityPageEntry(themeDisplay.getScopeGroupId(), LayoutUtilityPageEntryConstants.Type.TERMS_OF_USE.getType());
...
if (
 layoutUtilityPageEntry != null ) {
      ...
      _jspx_th_liferay$1layout_render$1layout$1utility$1page$1entry_0.setType( layoutUtilityPageEntry.getType() );
